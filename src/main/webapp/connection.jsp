...
<body>
	...
	<form action="connection" method="post">
		<fieldset class= "marge">
			...
			<div class="flex-row">
				<label class="lf--label" for="numeroClient"> <svg x="0px"
						y="0px" width="10px" height="9px">
        <path fill="#ffe3ec"
				...
				</label> <input id="numeroClient" name="numeroClient" class='lf--input'
					placeholder='Numéro du client' type='number' required
			value="<%=(request.getParameter("numeroClient")==null?"":request.getParameter("numeroClient"))%>">
			</div>
			<div class="flex-row">
				<label class="lf--label" for="motDePasse"> <svg x="0px"
						y="0px" width="15px" height="5px">
        <g>
          <path fill="#ffe3ec"
				...
				</label> <input id="motDePasse" name="motDePasse" class='lf--input'
